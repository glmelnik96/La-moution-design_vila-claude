...
var DARK=[0.13333, 0.13333, 0.13333], LIGHT=[0.949, 0.949, 0.949], GREEN=[0.149, 0.816, 0.486], DOT=[0.4, 0.4, 0.4];
var MONO="SBSansTextMono-Regular", MONOB="SBSansTextMono-Bold";
var SIZE=68, CHIPH=121.943, PITCH=150.844, CHIPDY=-17.5655;
var PADX=23.12, GAP=35.36, NCOL=5, ARROWW=176.8, CELL=42.3436;
var CY0=325.782, CX=1920;
var ROWS = [[[0, "G", "@dataclass"], [2, "A", 0], [3, "L", "frozen"], [4, "D", 7]], [[0, "L", "class"], [1, "L", "snapshot"], [3, "D", 9], [4, "D", 5]], [[1, "L", "label"], [2, "A", 0], [3, "L", "str"]], [[1, "L", "employees"], [2, "A", 0], [3, "L", "int"]], [[1, "L", "verified"], [2, "A", 0], [3, "L", "bool"]], [[0, "L", "timeline"], [2, "A", 0], [3, "D", 8], [4, "D", 6]], [[1, "G", "\u0441\u0442\u0430\u0440\u0442"], [2, "A", 0], [3, "L", "10"], [4, "L", "false"]], [[1, "G", "\u0441\u0435\u0433\u043e\u0434\u043d\u044f"], [2, "A", 0], [3, "L", "2000"], [4, "L", "true"]], [[0, "L", "def"], [1, "L", "growth"], [2, "A", 0], [3, "L", "b/a"]], [[0, "G", ">>>"], [2, "A", 0], [3, "L", "200.0"], [4, "D", 6]], [[0, "G", "team.launch()"], [2, "A", 0], [3, "D", 8], [4, "D", 4]]];
...
chip(rule, X0 - PADX, X0 + maxW + PADX, 1080, 10, GREEN);
...
bp.setValueAtTime(f(13), [0, 264.8]); bp.setValueAtTime(f(16), [0, 1895.2]); reveal(bp);
...
STEP_="result";
var num = txt("FX NUM", "\u00d7200", MONOB, 420, LIGHT, true);
var nr = num.sourceRectAtTime(0, false);
num.property("Transform").property("Position").setValue([CX, 990 - (nr.top + nr.height/2)]);
...
var capY = 1330;
var cap = txt("FX CAP", "\u0440\u043e\u0441\u0442 \u043a\u043e\u043c\u0430\u043d\u0434\u044b \u0437\u0430 7 \u043b\u0435\u0442", MONO, SIZE, DARK, true);
